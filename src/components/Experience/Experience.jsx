...
◦ Worked on Establishing accurate SEO scores along with metadata optimization.
      ...
      <div className="experience_title">
            <h2>B2B Content Writer & Correspondent</h2>
...
• Developed landing page content via coordination with UX/UI team for ‘Womanufacturing’ event
              ...
              <div className="experience_title">
                  ...
                  <small>Machine Maker</small>
                  <div className="experience_details">
                  Strategised content with a focus on the B2B sector. Tasks included writing, editing, and publishing stories, news, ghostwriting articles with a specialized taste of the manufacturing sector.
                  </div>
              </div>


            <div className="experience_title">
            <h2>Volunteering-Campus Ambassador</h2>
              <small>Internshala</small>
              <div className="experience_details">
              Volunteered for Internshala, one of the leading online training and internship
platforms, and raised brand awareness through social media networks. Brought 35 new registrations on the portal.
              </div>
        </div>   
      </div>
    </section>
